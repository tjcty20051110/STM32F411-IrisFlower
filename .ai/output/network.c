...
#define AI_NETWORK_MODEL_SIGNATURE     "e19da191dc2ba74f27aed07f9701325c"
...
#define AI_TOOLS_DATE_TIME   "Sat May 16 08:17:10 2026"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 12, 3, 1, 1), AI_STRIDE_INIT(4, 4, 48, 144, 144),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1292, 1, 1),
    1292, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_output_array.data = AI_PTR(g_network_activations_map[0] + 32);
    input_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32);
    
    _fc1_Gemm_output_0_output_array.data = AI_PTR(g_network_activations_map[0] + 48);
    _fc1_Gemm_output_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 48);
    
    _relu_Relu_output_0_output_array.data = AI_PTR(g_network_activations_map[0] + 48);
    _relu_Relu_output_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 48);
    ...
    _relu_1_Relu_output_0_output_array.data = AI_PTR(g_network_activations_map[0] + 48);
    _relu_1_Relu_output_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 48);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    _fc1_Gemm_output_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 256);
    _fc1_Gemm_output_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 256);
    
    _fc2_Gemm_output_0_weights_array.format |= AI_FMT_FLAG_CONST;
    _fc2_Gemm_output_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 320);
    _fc2_Gemm_output_0_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 320);
    
    _fc2_Gemm_output_0_bias_array.format |= AI_FMT_FLAG_CONST;
    _fc2_Gemm_output_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 1088);
    _fc2_Gemm_output_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1088);
    
    output_weights_array.format |= AI_FMT_FLAG_CONST;
    output_weights_array.data = AI_PTR(g_network_weights_map[0] + 1136);
    output_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1136);
    
    output_bias_array.format |= AI_FMT_FLAG_CONST;
    output_bias_array.data = AI_PTR(g_network_weights_map[0] + 1280);
    output_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1280);
